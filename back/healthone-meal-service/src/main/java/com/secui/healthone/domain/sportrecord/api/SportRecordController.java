...
public class SportRecordController {
    ...
    @GetMapping
    public RestApiResponse<List<SportRecordResDto>> getSportRecordList(@Valid @RequestParam("date") String date) {
        Integer userNo = 1;
    ...
    @PostMapping
    public RestApiResponse<SportRecordResDto> insertSportRecord(@Valid @RequestBody SportRecordReqDto reqDto) {
    ...
    @PatchMapping
    public RestApiResponse<SportRecordResDto> updateSportRecord(@Valid @RequestBody SportRecordReqDto reqDto) {
        Integer userNo = 1;
        return new RestApiResponse<>("운동 기록 수정 성공", sportRecordService.updateSportRecord(reqDto, userNo));
    }
    ...
    @DeleteMapping
    public RestApiResponse<Integer> deleteSportRecord(@Valid @RequestParam("no") Integer no) {
