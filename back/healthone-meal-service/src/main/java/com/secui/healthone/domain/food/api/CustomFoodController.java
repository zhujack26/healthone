...
public class CustomFoodController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "사용자 음식 데이터 단건 조회 성공", content = {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "사용자 음식 데이터 검색 성공", content = {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "사용자 음식 데이터 등록 성공", content = {
                    @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = CustomFoodResDto.class))),
                    @Content(mediaType = "*/*", schema = @Schema(implementation = RestApiResponse.class))
            }),
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "사용자 음식 데이터 수정 성공", content = {
                    @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = CustomFoodResDto.class))),
                    @Content(mediaType = "*/*", schema = @Schema(implementation = RestApiResponse.class))
            }),
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "사용자 음식 데이터 삭제 성공", content = {
                    @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = CustomFoodResDto.class))),
                    @Content(mediaType = "*/*", schema = @Schema(implementation = RestApiResponse.class))
            }),
    })
